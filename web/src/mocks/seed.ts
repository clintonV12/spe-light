...
export const MOCK_AUDIT_LOG: import('../types').AuditLog[] = [
  {
    id: 'audit-001', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'plan.created', table_name: 'plans', record_id: 'plan-001',
    record_label: '2025–2027 National Economic Development Strategy',
    diff: {}, created_at: '2025-01-10T08:12:00Z',
  },
  {
    id: 'audit-002', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'activity.created', table_name: 'activities', record_id: 'act-001',
    record_label: 'National SWOT Analysis',
    diff: {}, created_at: '2025-01-12T08:30:00Z',
  },
  {
    id: 'audit-003', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'activity.status_changed', table_name: 'activities', record_id: 'act-001',
    record_label: 'National SWOT Analysis',
    diff: { status: { from: 'not_started', to: 'in_progress' } },
    created_at: '2025-01-20T09:15:00Z',
  },
  {
    id: 'audit-004', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'user.invited', table_name: 'invitations', record_id: 'inv-001',
    record_label: 'sipho.mamba@gmail.com (planner)',
    diff: {}, created_at: '2025-02-01T10:00:00Z',
  },
  {
    id: 'audit-005', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'activity.status_changed', table_name: 'activities', record_id: 'act-001',
    record_label: 'National SWOT Analysis',
    diff: { status: { from: 'in_progress', to: 'complete' } },
    created_at: '2025-02-01T14:22:00Z',
  },
  {
    id: 'audit-006', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'plan.created', table_name: 'plans', record_id: 'plan-002',
    record_label: 'Digital Transformation Roadmap 2025',
    diff: {}, created_at: '2025-02-15T09:00:00Z',
  },
  {
    id: 'audit-007', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'user.role_changed', table_name: 'users', record_id: 'user-003',
    record_label: 'Lungile Shabalala',
    diff: { role: { from: 'viewer', to: 'contributor' } },
    created_at: '2025-03-10T11:30:00Z',
  },
  {
    id: 'audit-008', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'activity.created', table_name: 'activities', record_id: 'act-007',
    record_label: 'Vision & Mission Statement',
    diff: {}, created_at: '2025-02-20T08:00:00Z',
  },
  {
    id: 'audit-009', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'link.created', table_name: 'activity_links', record_id: 'link-001',
    record_label: 'National SWOT Analysis → Strategic Objectives 2025–2027',
    diff: { link_type: { from: null, to: 'auto' } },
    created_at: '2025-03-01T08:05:00Z',
  },
  {
    id: 'audit-010', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'plan.updated', table_name: 'plans', record_id: 'plan-001',
    record_label: '2025–2027 National Economic Development Strategy',
    diff: { status: { from: 'draft', to: 'active' } },
    created_at: '2025-03-15T09:00:00Z',
  },
  {
    id: 'audit-011', org_id: 'org-001', user_id: 'user-003',
    user_name: 'Lungile Shabalala', user_email: 'lungile@eda.org.sz',
    action: 'activity.status_changed', table_name: 'activities', record_id: 'act-009',
    record_label: 'KPI Framework',
    diff: { status: { from: 'not_started', to: 'in_progress' } },
    created_at: '2025-03-20T13:44:00Z',
  },
  {
    id: 'audit-012', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'user.deactivated', table_name: 'users', record_id: 'user-004',
    record_label: 'Nomcebo Mthembu',
    diff: { is_active: { from: true, to: false } },
    created_at: '2024-11-01T10:00:00Z',
  },
  {
    id: 'audit-013', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'report.generated', table_name: 'reports', record_id: 'rpt-001',
    record_label: 'Executive Summary — National Economic Development Strategy',
    diff: { format: { from: null, to: 'pdf' } },
    created_at: '2025-05-15T09:00:00Z',
  },
  {
    id: 'audit-014', org_id: 'org-001', user_id: 'user-001',
    user_name: 'Themba Dlamini', user_email: 'admin@eda.org.sz',
    action: 'activity.status_changed', table_name: 'activities', record_id: 'act-015',
    record_label: 'Q2 2025 Action Items',
    diff: { status: { from: 'not_started', to: 'in_progress' } },
    created_at: '2025-06-01T08:22:00Z',
  },
  {
    id: 'audit-015', org_id: 'org-001', user_id: 'user-002',
    user_name: 'Sifiso Nkosi', user_email: 'sifiso@eda.org.sz',
    action: 'invitation.resent', table_name: 'invitations', record_id: 'inv-001',
    record_label: 'sipho.mamba@gmail.com',
    diff: {}, created_at: '2025-06-10T11:00:00Z',
  },
]
